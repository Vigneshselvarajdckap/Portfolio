    ...
    <section className="relative h-screen bg-slate-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <button className="bg-blue-500 px-8 py-3 rounded-lg hover:bg-blue-600 hover:scale-105 transition-all duration-300">
            View Projects
          </button>

          <button className="border border-blue-400 text-blue-400 px-8 py-3 rounded-lg hover:bg-blue-400 hover:text-white hover:scale-105 transition-all duration-300">
            Contact Me
          </button>
        </div>
      </div>
